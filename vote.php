...
if(!isset($_SESSION["admin"]))
	...
	for ($i=0; $i <$num ; $i++) { 
		$row=mysqli_fetch_array($result);
		echo "<div><input type='radio' name='opt' value='".$row['id']."' >".$row['ctext']."</div><div><img src='http://localhost:8081/hellophp/".$row['img']."' width=100 height=100/></div>";
		echo "投票数：".$row["count"]." ";
	}
...
<div><a href="fabutoupiao.php">返回</a></div>
</form>
