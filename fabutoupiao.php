		...
		<div class="row">
			...
			<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
           		 <div class="header-thumb">
              		 <h1 class="wow fadeIn" >用户在这里发布投票项目</h1>
              		 <h3 class="wow fadeInUp" >经管理员审核方能投票</h3>
           		 </div>
			</div>
      ...
      <div class="row">
		...
		<div class="wow fadeInUp col-md-7 col-sm-7" >
			...
			for($i=1;$i<$num+1;$i++){
				...
				echo "<h1>投票 ".$i."：<a href='vote.php?id=".$row['id']."' >".$row['title']."</a></h1><br>";
			}
			mysqli_close($conn);
			?>
			<div class="col-xs-offset-2">
			<br>
			<div><a class="btn btn-default btn-lg" href="creatvote.html">创建你的投票</a></div>
			</div>
		</div>
